...
Shunt::Shunt() : nopstack(0),
                 nnumstack(0),
                 operators{
                     {'_', 10, ASSOC_RIGHT, 1, &Shunt::eval_uminus},
                     {'^', 9, ASSOC_RIGHT, 0, &Shunt::eval_exp},
                     {'*', 8, ASSOC_LEFT, 0, &Shunt::eval_mul},
                     {'/', 8, ASSOC_LEFT, 0, &Shunt::eval_div},
                     {'%', 8, ASSOC_LEFT, 0, &Shunt::eval_mod},
                     {'+', 5, ASSOC_LEFT, 0, &Shunt::eval_add},
                     {'-', 5, ASSOC_LEFT, 0, &Shunt::eval_sub},
                     {'(', 0, ASSOC_NONE, 0, NULL},
                     {')', 0, ASSOC_NONE, 0, NULL},
                 },
                 opstack{NULL}
